  ...
  render(){
    return(
      <View style={styles.container}>
        ...
        <Image style= {{width:150,height:160}} source={require('../assets/dog.png')} />
          
          <Text style={styles.title}>Maw And Paw</Text>
          <Text style={{color:'#ff8a65'}}> Lets Take Care of Them </Text>
        </View>
